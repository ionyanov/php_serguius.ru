...
//-----------------------------------------------------------------------------------------------------------
	function initSettings(){
		$this->TO_INDEX_TITLE = 'To the Main Page. �� ������� ��������';
		...
		$this->KEYWORDS ="����� ������� ����������� ��������� ���������� �������� ��������� ������� ��������� ������� �������� ������ ������� ���������� ����� ��������� ������� ����� ������ ������ ������ ������� ��������� ������� ����� �������� ������� ������ �� ������ Agasaryen Agasaryan";
		$this->KEYWORDS2 ="����� ������� �������� ������� ���������� ����� ������� ������ �������� ��������� ������ ��������� ������ �� ������ ���������� ���������";
		$this->COPYRIGHT ="Serguey Agasaryen ������ ��������";
		$this->CLASSIFICATION ="��������������� ���������. �������. ����������";
...
//-----------------------------------------------------------------------------------------------------------
	function getNewCategory() {
        return array('title'=>'�����','is_active'=>1,'name'=>'new','order'=>$this->getNextCategoryOrder()
